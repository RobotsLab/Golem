...
void NxDebugRenderer::renderBuffer(float* pVertList, float* pColorList, int type, int num)
{
	// Make sure no other arrays are active, crashes will be the result!
...
void NxDebugRenderer::renderData(const NxDebugRenderable& data) const
{
	glLineWidth(1.0f);
