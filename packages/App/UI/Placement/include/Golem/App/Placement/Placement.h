...
#pragma once
#ifndef _GOLEM_APP_PLACEMENT_PLACEMENT_H_ // if #pragma once is not supported
#define _GOLEM_APP_PLACEMENT_PLACEMENT_H_
...
/** AppPlacement. */
class AppPlacement : public golem::Player {
public:
	...
	protected:
		GOLEM_CREATE_FROM_OBJECT_DESC1(AppPlacement, golem::Object::Ptr, golem::Scene&)
	};
...
protected:
	...
	AppPlacement(golem::Scene &scene);
	~AppPlacement();
};

//------------------------------------------------------------------------------

void XMLData(golem::AppPlacement::Data::Cluster::Map::value_type& val, golem::XMLContext* context, bool create = false);

void XMLData(golem::AppPlacement::PoseDensity::Map::value_type& val, golem::XMLContext* context, bool create = false);

template <> void Stream::read(golem::AppPlacement::Data::Training::Map::value_type& value) const;
template <> void Stream::write(const golem::AppPlacement::Data::Training::Map::value_type& value);

template <> void Stream::read(golem::AppPlacement::Data::Density::Seq::value_type& value) const;
template <> void Stream::write(const golem::AppPlacement::Data::Density::Seq::value_type& value);

template <> void Stream::read(golem::AppPlacement::Data::Solution::Seq::value_type& value) const;
template <> void Stream::write(const golem::AppPlacement::Data::Solution::Seq::value_type& value);
