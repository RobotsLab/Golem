...
void VirtualCamera::ReprojectPointCloud(pcl::PointCloud<pcl::PointXYZRGBNormal> * cloud,
		  cv::Mat &depth_map, Eigen::Vector4f origin, Eigen::Vector3f &newGaze, Eigen::Vector3f &centerPoint,
