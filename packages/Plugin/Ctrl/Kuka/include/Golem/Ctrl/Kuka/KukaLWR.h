...
#pragma once
#ifndef _GOLEM_CTRL_KUKA_KUKALWR_H_
#define _GOLEM_CTRL_KUKA_KUKALWR_H_
...
/** KukaLWR kinematic chain base class */
class GOLEM_LIBRARY_DECLDIR KukaLWRChain : public Chain {
public:
...
//			L6 = REAL_ZERO; // [m]
	...
	public:
		...
		CREATE_FROM_OBJECT_DESC_1(KukaLWRChain, Chain::Ptr, Controller&)
...
protected:
	...
	KukaLWRChain(Controller& controller);
...
public:
	...
	/** Sets KukaLWR Chain model */
	void setChainModel(const ChainModel& chainModel);
	/** Current KukaLWR Chain model */
...
/** KukaLWR controller base class. */
class GOLEM_LIBRARY_DECLDIR KukaLWR: public SingleCtrl {
public:
	...
	/** KukaLWR state reserved area variable indices */
	enum ReservedIndex {
		/**To FRI */
...
#endif /*_GOLEM_CTRL_KUKA_KUKALWR_H_*/
