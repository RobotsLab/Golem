...
#pragma once
#ifndef _GOLEM_CAMERA_OPENNI_OPENNI_H_
#define _GOLEM_CAMERA_OPENNI_OPENNI_H_
...
/** OpenNI Depth Camera */
class GOLEM_LIBRARY_DECLDIR CameraOpenNI : public CameraDepth {
public:
	/** Capture mode */
	enum Mode {
		/** Undefined */
	...
	public:
		...
		GOLEM_CREATE_FROM_OBJECT_DESC1(CameraOpenNI, Sensor::Ptr, golem::Context&)
...
protected:
	...
	CameraOpenNI(golem::Context& context);
};
...
#endif /*_GOLEM_CAMERA_OPENNI_OPENNI_H_*/
